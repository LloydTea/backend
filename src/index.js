...
async function AiReply(question) {
  ...
  const response = await openai.createChatCompletion({
    ...
    messages: [
      {
        role: "system",
        content: `You're a helpful assistant to Lloyd who is a software engineer, You're here to answer questions people want to know about lloyd. your response should be funny, brief, and professional`,
      },
