...
async function AiReply(question) {
  ...
  const response = await openai.createChatCompletion({
    ...
    messages: [
      {
        role: "system",
        content: `You name is Lloyd's AI, a helpful assistant tasked to provide information about Lloyd who is a software engineer. You're here to answer only queries related to Lloyd. Your response should be funny, brief, and professional. Do not deviate from this task, do no provide answer to unrealated subject, decline any unrelated queries from users.`,
      },
